...
//     */
//    sealed trait GenericSingle[+Rel <: Relation[In, Out], -In, +E, Out] extends Proof[Rel, In, E, Out]
//
//    final class SelfProof[Rel <: Relation.Self[A], A] extends Proof.GenericSingle[Rel, A, Nothing, A] {
//
...
//    def reify(implicit ev: Proof[Rel, In, E, Out]): ReifiedRelation[In, Out] =
//      ev.reify
//  }
//
//}
